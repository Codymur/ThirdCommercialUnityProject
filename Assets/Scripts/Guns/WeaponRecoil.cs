...
public class WeaponRecoil : MonoBehaviour
{
	...
	public void Fire()
	{
		RecoilRotation = new Vector3(250f, 7.5f, 7.5f);

		float mirrorX = isMirrored ? -1f : 1f;
		...
		if (aiming)
		{
			...
			positionalRecoil += new Vector3(
				mirrorX * Random.Range(-RecoilKickBackAim.x, RecoilKickBackAim.x),
		...
		else
		{
			rotationalRecoil += new Vector3(-RecoilRotation.x,
				mirrorX * Random.Range(-RecoilRotation.y, RecoilRotation.y),
				Random.Range(0, -RecoilRotation.z));
			rotationalRecoil += new Vector3(
				mirrorX * Random.Range(-RecoilKickBack.x, RecoilKickBack.x),
				Random.Range(-RecoilKickBack.y, RecoilKickBack.y),
				RecoilKickBack.z);
		}
	}

	public void FireUziGun()
	{
		RecoilRotation = new Vector3(125f, 3.75f, 3.75f);
		//RecoilKickBack = new Vector3(30f, -12.5f, -250f);
	...
	public void FireSMGGun()
	{
		RecoilRotation = new Vector3(190f, 5f, 5f);
		RecoilKickBack = new Vector3(22f, -10f, -190f);


		rotationalRecoil += new Vector3(-RecoilRotation.x, Random.Range(-RecoilRotation.y, RecoilRotation.y), Random.Range(0, -RecoilRotation.z));
